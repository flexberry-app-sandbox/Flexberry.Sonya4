...
namespace IIS.Sonya4
{
    ...
    public class Материалы : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Sonya4.Единицы fЕдиницы;
        ...
        public virtual IIS.Sonya4.Единицы Единицы
        {
            get
            {
                ...
                IIS.Sonya4.Единицы result = this.fЕдиницы;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View МатериалыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МатериалыE", typeof(IIS.Sonya4.Материалы));
                }
            }
            ...
            public static ICSSoft.STORMNET.View МатериалыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МатериалыL", typeof(IIS.Sonya4.Материалы));
                }
            }
        }
    }
