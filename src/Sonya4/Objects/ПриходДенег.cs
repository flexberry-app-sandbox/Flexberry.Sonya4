...
namespace IIS.Sonya4
{
    ...
    public class ПриходДенег : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Sonya4.ТипПрихода fТипПрихода;
        
        private int fСумма;
        
        private IIS.Sonya4.Клиенты fКлиенты;
        
        private IIS.Sonya4.DetailArrayOfСоставТовары fСоставТовары;
        
        private IIS.Sonya4.DetailArrayOfСоставУслуги fСоставУслуги;
        ...
        public virtual IIS.Sonya4.ТипПрихода ТипПрихода
        {
            get
            {
                ...
                IIS.Sonya4.ТипПрихода result = this.fТипПрихода;
        ...
        [PropertyStorage(new string[] {
                "Клиенты"})]
        [NotNull()]
        public virtual IIS.Sonya4.Клиенты Клиенты
        {
            get
            {
                ...
                IIS.Sonya4.Клиенты result = this.fКлиенты;
        ...
        public virtual IIS.Sonya4.DetailArrayOfСоставТовары СоставТовары
        {
            get
            {
                ...
                {
                    this.fСоставТовары = new IIS.Sonya4.DetailArrayOfСоставТовары(this);
                }
                IIS.Sonya4.DetailArrayOfСоставТовары result = this.fСоставТовары;
        ...
        public virtual IIS.Sonya4.DetailArrayOfСоставУслуги СоставУслуги
        {
            get
            {
                ...
                {
                    this.fСоставУслуги = new IIS.Sonya4.DetailArrayOfСоставУслуги(this);
                }
                IIS.Sonya4.DetailArrayOfСоставУслуги result = this.fСоставУслуги;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПриходДенегE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПриходДенегE", typeof(IIS.Sonya4.ПриходДенег));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПриходДенегL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПриходДенегL", typeof(IIS.Sonya4.ПриходДенег));
                }
            }
        }
    }
